...
Rails.application.configure do
  ...
  config.action_mailer.smtp_settings = {
    address:              ENV.fetch("MAIL_HOST", "sandbox.smtp.mailtrap.io"),
    port:                 ENV.fetch("MAIL_PORT", 2525).to_i,
  ...
  # Set log level based on APP_DEBUG environment variable
  config.log_level = ENV["APP_DEBUG"] == "true" ? :debug : :info
end
